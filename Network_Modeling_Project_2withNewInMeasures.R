...
seir_model <- function(adj_matrix, beta, sigma, gamma, initial_exposed, days, superspreaders = NULL, mask_day = NULL, mask_efficacy = 0.1) {
  n <- nrow(adj_matrix)
...
infected_day2 <- get_compartment_totals(result2$states, 2, "I")
infected_day4 <- get_compartment_totals(result2$states, 4, "I")
infected_day5 <- get_compartment_totals(result2$states, 5, "I")
infected_day8 <- get_compartment_totals(result2$states, 8, "I")
infected_day20 <- get_compartment_totals(result2$states, 20, "I")
cat("a) Number of infected individuals:\n")
cat("   Day 2:", infected_day2, "people\n")
cat("   Day 4:", infected_day4, "people\n")
cat("   Day 8:", infected_day8, "people\n\n")
